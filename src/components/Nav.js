...
function Nav( {setScreen} ) {
  ...
  const renderMenu = (
    ...
    >
      <MenuItem onClick={() => clickItem(PROFILE)}>Профиль</MenuItem>
      <MenuItem onClick={() => clickItem(PROFILE)}>Мой офис</MenuItem>
    </Menu>
  );
...
const ConnectNav = connect(mstp, mdtp)(Nav)
